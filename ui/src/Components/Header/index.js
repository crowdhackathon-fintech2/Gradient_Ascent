...
class SimpleAppBar extends Component {
  state = { loggedIn: true, value: "EXISTING" };
  ...
  right(classes) {
    ...
    return loggedIn ? (
      <div className={`${classes.item} ${classes.right}`}>
        ...
        <IconButton
          onClick={() => this.setState(s => ({ loggedIn: false }))}
      ...
      <div className={`${classes.item} ${classes.right}`}>
        <Button
          to="/a"
          onClick={() => this.setState(s => ({ loggedIn: true }))}
